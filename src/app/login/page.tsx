  ...
  return (
    <div className="mx-auto max-w-md space-y-6 rounded-2xl border border-white/10 bg-slate-900/60 p-6 shadow-lg shadow-black/40">
      ...
      <p className="text-sm text-slate-300">
        Click the button below to sign in with your Discord account. Your
        Discord name and profile picture will be used as your identity on this
        site.
      </p>
      <p className="text-xs text-slate-400">
        After authorizing the app on Discord, you will be redirected back here
        as a logged-in user.
      </p>
